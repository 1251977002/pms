        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-primary" >
            ...
            <div class="box-header with-border">
			  <li class = "fa fa-pencil-square-o" style = "color:#00a65a"></li>
              <h1 class="box-title">编辑目标</h1>
            ...
            <div class="box-body">
				...
				<form class="form-horizontal" action="/goal/updateGoalById" method="post">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" name="goalcontent"  rows="10" ></textarea>
					</div>
				  </div>
