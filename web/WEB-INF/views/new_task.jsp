        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-primary" >
            ...
            <div class="box-header with-border">
			  <li class = "fa fa-plus-square-o" style = "color:#00a65a"></li>
              <h1 class="box-title">添加新任务</h1>
            ...
            <div class="box-body">
                ${goal.id}
				<form class="form-horizontal" action="/task/addtask?id=${goal.id}" method="post">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <div class="input-group">
						...
						<input type="text" class="form-control" id = "datepicker1" name="begintime">
					  </div>
					</div>
				  </div>
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <div class="input-group">
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						<input type="text" class="form-control" id = "datepicker2" name="endtime">
					  </div>
					</div>
				  </div>
				  <div class="form-group">
					<label class="control-label col-sm-2" >项目描述</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-2" >级别</label>
					<div class="col-sm-10">
						<select class="form-control" name="level">
							<option value = "">重要紧急</option>
							<option>重要不紧急</option>
							<option>紧急不重要</option>
				  ...
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  <button type="submit" class="btn btn-primary btn-flat">
						<li class = "fa fa-plus"></li>&nbsp;保存
					  </button>
					  <a href = "/task/showtask" class="btn btn-danger btn-flat pull-right">
...
<script src="../../adminlte/js/bootstrap-datepicker.zh-CN.min.js"></script>
