     ...
     <div class="row">
        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-primary" >
            ...
            <!-- /.box-header -->
            <div class="box-body">
				<form class="form-horizontal" action="/goal/addgoal" method="post">
				  <div class="form-group">
					<label class="control-label col-sm-2">目标名称</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-2" >目标描述</label>
					<div class="col-sm-10">
						<textarea class="form-control" name="goaltext" id="" rows="10"></textarea>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  <button type="submit" class="btn btn-success btn-flat">
						<li class = "fa fa-plus"></li>&nbsp;添加
					  </button>
					  <a href = "/goal/showgoal" class="btn btn-danger btn-flat pull-right">
