    ...
    <%-- <div class="row">
        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-widget">
            ...
            <div class="box-body">
              <!-- post text -->
              <h4><strong>资料标题</strong></h4>

              <p>没有the coast of the Semantics, a large language ocean.
                A small river named Duden flows by their place and supplies
                it with the necessary regelialia. It is a paradisematic
                country, in which roasted parts of sentences fly into
                your mouth.....<a href = "/document/readAll" target = "_blank">阅读全文</a></p>

              <!--<button type="button" class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
              <button type="button" class="btn btn-default btn-xs"><i class="fa fa-commenting-o"></i> Comments</button>-->
              <span class="pull-right text-muted">
				<i class="fa fa-thumbs-o-up"></i>&nbsp;45&nbsp;  
	  ...
	  <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="../../adminlte/img/user5-128x128.jpg" alt="User Image">
                <span class="username"><a href="#">Jonathan Burke Jr.</a></span>
                <span class="description">发布于23分钟之前</span>
              </div>
              <!-- /.user-block -->
            ...
            <div class="box-body">
              ...
              <p>没有the coast of the Semantics, a large language ocean.
                ...
                it with the necessary regelialia. It is a paradisematic
                country, in which roasted parts of sentences fly into
                your mouth.....<a href = "document_show.jsp" target = "_blank">阅读全文</a></p>
	  ...
	  <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="../../adminlte/img/user3-128x128.jpg" alt="User Image">
                <span class="username"><a href="#">Jonathan Burke Jr.</a></span>
                <span class="description">发布于23分钟之前</span>
              </div>
              <!-- /.user-block -->
...
<script id="template" type="x-tmpl-mustache">
  ...
  <span class="description">{{createtime}}</span>
          </div>
          <!-- /.user-block -->
          <div class="box-tools">
          ...
          <p>{{content}}
            <a href = "/document/readAll?id={{id}}">阅读全文</a>
          </p>
