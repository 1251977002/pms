    ...
    <section class="content">
        ...
        <c:choose>
            <c:when test="${ (!empty List) && (fn:length(List) > 0)}">
                <c:forEach var="goal" items="${List}" varStatus="sta">
                    <!-- /.row -->
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h1 class="box-title"><a href = "/task/showtask?id=${goal.id}">${goal.name}</a></h1>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <div class = "pull-right">
                                        ${goal.id}
                                        <a href="/goal/updategoal?id=${goal.id}" class="btn bg-olive btn-flat margin"><li class = "fa fa-edit"></li>&nbsp;编辑</a>
                                    </div>
