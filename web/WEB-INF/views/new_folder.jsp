        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-primary" >
            ...
            <div class="box-header with-border">
              ...
              <h1 class="box-title">新建文件夹</h1>
		
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				<form class="form-horizontal" action="/file/addfile" method="post">
				  <div class="form-group">
                    ...
                    <br>
                    <label class="control-label col-sm-2">文件路径</label>
                    <div class="col-sm-10">
				  ...
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  ...
					  <a href = "/file/showfile" class="btn btn-default">
						返回
					  </a>
					</div>
				  </div>
