        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-primary" >
			...
			<div class="box-header with-border">
              ...
              <h1 class="box-title">${contact.id}编辑联系人</h1>
		
            </div>
           
            <!-- /.box-header -->
            <div class="box-body">
				<form class="form-horizontal" action="/contact/editcontact" method="post">
				  ...
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  ...
					  <a href = "/contact/contactlist" class="btn btn-danger btn-flat pull-right">
