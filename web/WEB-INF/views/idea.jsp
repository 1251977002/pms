...
<%--<c:choose>
  <c:when test="${ (!empty List) && (fn:length(List) > 0)}">
    <c:forEach var="idea" items="${List}" varStatus="sta">
     <div class="row">
		  ...
		  <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <span class="username"><a href="#">${user1.username}</a></span>
                <span class="description">${idea.createtime}</span>
              </div>
              <!-- /.user-block -->
              <div class="box-tools">
            ...
            <div class="box-body">
              ...
              <p>${idea.content}
                <a href = "/idea/showAllidea">阅读全文</a>
              </p>
        ...
        <div class="col-md-12">
		  ...
		  <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <p>{{content}}
                <a href = "/idea/showthisidea?id={{id}}">阅读全文</a>
              </p>
