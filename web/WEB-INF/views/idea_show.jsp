		  ...
		  <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <span class="username"><a href="#">${idea.username}</a></span>
                <span class="description">${idea.createtime}</span>
              </div>
              <!-- /.user-block -->
              <div class="box-tools">
                
                <a href = "/idea/showidea">返回想法列表</a>
...
<script>
    $(function () {
            ...
            var options = {//根据后台返回的分页相关信息，设置插件参数
              ...
              onPageClicked: function (event, originalEvent, type, page) {//分页按钮点击事件
                $.ajax({//根据page去后台加载数据
                  ...
                  type: "get",
                  dataType: "json",
                  data: {pageNo: page,ideaId:${idea.id}},
                  success: function (data) {
                    var template = $('#template').html();
                    Mustache.parse(template);
                    $(".comments").html("");
      ...
      $(".send").click(function () {
        var cont = $("#incomt").val();
        $.get("/idea/addcomment",{cont:cont, ideaId:${idea.id}},function (json) {
          var template = $('#template').html();
          Mustache.parse(template);
